...
var game = (function(){
    ...
    var context;
    var keys = [];
    let vidInput = ["left","right","straight"]
    var startTime;
    var lastDelta = 0;
...
function setup() {
  ...
  noneButton = createButton('straight');
  noneButton.mousePressed(function () {
    classifier.addImage('straight');
  });
  /*stopButton = createButton('brake');
  stopButton.mousePressed(function () {
    classifier.addImage('brake');
  });*/
